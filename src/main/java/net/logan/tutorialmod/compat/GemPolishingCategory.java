package net.logan.tutorialmod.compat;
...
import net.logan.tutorialmod.Recipe.GemPolishingRecipe;
...
public class GemPolishingCategory implements IRecipeCategory<GemPolishingRecipe> {
    ...
    public static final ResourceLocation TEXTURE = new ResourceLocation(TutorialMod.MOD_ID, "textures/gui/gem_polishing_station_gui.png");
